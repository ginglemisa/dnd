(() => {
  ...
  function ensureStyles() {
    ...
    style.textContent = `
      ...
      #quick-build-wizard .quick-build-shell{display:flex;flex-direction:column;width:780px;max-width:100%;max-height:calc(100dvh - 32px);overflow:hidden;border:1px solid var(--qb-border);border-radius:16px;background:var(--qb-surface);color:var(--qb-text);box-shadow:0 24px 70px var(--shadow-strong)}
      #quick-build-wizard .quick-build-header{display:flex;flex:0 0 auto;gap:16px;align-items:flex-start;justify-content:space-between;min-width:0;padding:20px 20px 12px;border-bottom:1px solid var(--qb-border-soft)}
      ...
      #quick-build-wizard .quick-build-progress{margin:5px 0 0;color:var(--qb-text-body);font-size:.9rem;line-height:1.45}
      ...
      #quick-build-wizard .quick-build-lead{margin:0 0 18px;color:var(--qb-text-body)}.quick-build-background-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:14px}.quick-build-class-grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:14px}
      #quick-build-wizard .quick-build-card{width:100%;min-height:0;padding:16px;border:1px solid var(--qb-border);border-radius:12px;background:var(--qb-surface-raised);color:var(--qb-text);text-align:left;cursor:pointer}
      #quick-build-wizard .quick-build-card:hover,#quick-build-wizard .quick-build-card:focus-visible{border-color:var(--qb-accent);background:#243449;outline:2px solid transparent}.quick-build-card h4{margin:0 0 10px;font-size:1.12rem;color:var(--qb-accent-text)}
      .quick-build-summary{display:grid;grid-template-columns:auto 1fr;gap:6px 10px;margin:0;font-size:.9rem;line-height:1.45}.quick-build-summary dt{color:var(--qb-text-muted)}.quick-build-summary dd{margin:0;color:var(--qb-text)}
      .quick-build-choice-panel{padding:18px;border:1px solid var(--qb-border);border-radius:12px;background:var(--qb-surface-soft, var(--surface-soft))}.quick-build-review-panel+ .quick-build-review-panel{margin-top:14px}.quick-build-review-panel>h4{margin:0 0 14px;color:var(--qb-text)}.quick-build-equipment-list{margin:12px 0 20px;padding:14px;border-radius:8px;background:var(--qb-surface-inset);line-height:1.7;color:var(--qb-text-body)}
      .quick-build-race-options{display:grid;gap:16px}.quick-build-option-note{margin:6px 0 0;color:var(--qb-text-muted);font-size:.9rem}.quick-build-ancestry-detail{margin:0;padding:14px;border:1px solid var(--qb-border);border-radius:9px;background:var(--qb-surface-inset);color:var(--qb-text-body);line-height:1.65}.quick-build-ancestry-detail strong{display:block;margin-bottom:5px;color:var(--qb-accent-text)}.quick-build-warning{margin:14px 0;padding:12px;border-left:4px solid #f59e0b;border-radius:7px;background:#422006;color:#fef3c7}.quick-build-pending{margin-top:14px;padding:12px;border-radius:7px;background:#312e81;color:#e0e7ff}
      .quick-build-choice-actions{display:grid;grid-template-columns:1fr 1fr;gap:12px}.quick-build-choice-actions button{min-height:48px;padding:10px;border:1px solid var(--qb-border);border-radius:8px;background:var(--qb-surface-raised);color:#fff;cursor:pointer}.quick-build-choice-actions button.primary{border-color:var(--qb-accent);background:var(--qb-accent-strong, var(--accent-strong))}.quick-build-choice-actions .quick-build-choice-action-full{grid-column:1/-1}
      .quick-build-change{margin:0 0 14px;padding:0;border:0;background:transparent;color:var(--qb-accent-text);text-decoration:underline;cursor:pointer}.quick-build-spell-layout{display:grid;gap:16px}
      .quick-build-spell-finish{width:100%;min-height:52px;margin:0;padding:12px 18px;border:1px solid var(--qb-accent);border-radius:9px;background:var(--qb-accent-strong, var(--accent-strong));color:#fff;font-size:1rem;font-weight:700;cursor:pointer}.quick-build-spell-finish:hover{background:var(--qb-accent-hover)}.quick-build-spell-finish:disabled{border-color:var(--qb-border);background:var(--qb-border-soft);color:var(--qb-text-muted);cursor:not-allowed}.quick-build-human-race-finish{display:block;width:12em;max-width:100%;min-height:46px;margin-right:auto;margin-left:auto;padding:9px 16px;border-color:var(--qb-accent);border-radius:8px;font-size:inherit}.quick-build-human-race-finish-top{margin-bottom:18px}.quick-build-human-race-finish-bottom{margin-top:18px}
      .quick-build-spell-fields{display:flex;flex-direction:column;gap:14px}.quick-build-field label{display:block;margin-bottom:6px;color:var(--qb-text-body)}.quick-build-field-control{display:grid;grid-template-columns:minmax(0,1fr) auto;gap:8px}.quick-build-field-control.has-confirm{grid-template-columns:minmax(0,1fr) auto auto}.quick-build-field select{width:100%;min-height:44px;padding:8px;border:1px solid var(--qb-border);border-radius:7px;background:var(--qb-surface-inset);color:#fff}.quick-build-spell-view,.quick-build-option-confirm{min-width:64px;margin:0;padding:8px 12px;border:1px solid var(--qb-border);border-radius:7px;background:var(--qb-surface-raised);color:#fff;cursor:pointer}.quick-build-option-confirm{border-color:var(--qb-accent);background:var(--qb-accent-strong, var(--accent-strong))}.quick-build-spell-view:disabled,.quick-build-option-confirm:disabled{color:var(--qb-text-muted);cursor:not-allowed;opacity:.55}
      #quick-build-spell-detail{position:fixed;inset:0;z-index:10030;display:none;align-items:center;justify-content:center;width:100%;max-width:none;padding:32px;overflow:hidden;overscroll-behavior:contain;background:var(--qb-overlay)}
      #quick-build-spell-detail.open{display:flex}#quick-build-spell-detail .quick-build-spell-detail-shell{display:flex;flex-direction:column;width:680px;max-width:calc(100% - 32px);max-height:calc(100dvh - 80px);overflow:hidden;border:1px solid var(--qb-border);border-radius:14px;background:var(--qb-surface);color:var(--qb-text);box-shadow:0 28px 80px var(--shadow-strong)}
      #quick-build-spell-detail .quick-build-spell-detail-header{display:flex;flex:0 0 auto;align-items:center;justify-content:space-between;gap:16px;padding:16px 18px;border-bottom:1px solid var(--qb-border-soft)}#quick-build-spell-detail-title{margin:0;color:var(--qb-text);font-size:1.2rem}
      #quick-build-spell-detail .quick-build-spell-detail-close{display:grid;flex:0 0 44px;place-items:center;width:44px;min-width:44px;height:44px;min-height:44px;margin:0;padding:0;border:1px solid transparent;border-radius:9px;background:var(--qb-surface-raised);color:var(--qb-text);font-size:1.5rem;line-height:1;cursor:pointer;touch-action:manipulation}#quick-build-spell-detail .quick-build-spell-detail-close:hover,#quick-build-spell-detail .quick-build-spell-detail-close:focus-visible{border-color:var(--qb-accent);background:#243449;outline:2px solid transparent}
      ...
      .quick-build-ability-heading{display:flex;align-items:flex-end;justify-content:space-between;gap:16px;margin:0 0 16px}.quick-build-ability-heading h3{margin:0!important}.quick-build-ability-status{display:flex;flex-wrap:wrap;justify-content:flex-end;gap:8px}.quick-build-status-pill{padding:6px 10px;border:1px solid var(--qb-border);border-radius:999px;background:var(--qb-surface-soft, var(--surface-soft));color:var(--qb-text-body);font-size:.82rem;line-height:1.2}.quick-build-status-pill strong{color:var(--qb-text)}.quick-build-status-pill.is-complete{border-color:#166534;background:#052e24;color:#bbf7d0}.quick-build-ability-confirm{display:block;width:12em;max-width:100%;min-height:46px;margin:0 auto 18px;padding:9px 16px;border:1px solid var(--qb-accent);border-radius:8px;background:var(--qb-accent-strong, var(--accent-strong));color:#fff;cursor:pointer}.quick-build-ability-confirm:disabled{border-color:var(--qb-border);background:var(--qb-border-soft);color:var(--qb-text-muted);cursor:not-allowed}.quick-build-ability-grid{display:grid;gap:12px;padding:14px}.quick-build-ability-row{display:grid;grid-template-columns:minmax(92px,.7fr) minmax(0,2fr) minmax(74px,.55fr);gap:16px;align-items:center;padding:14px 16px;border:1px solid var(--qb-border-soft);border-radius:10px;background:var(--qb-surface-inset)}.quick-build-ability-name{display:flex;flex-direction:column;gap:3px}.quick-build-ability-name strong{font-size:1.05rem;color:var(--qb-text)}.quick-build-ability-name small{color:var(--qb-text-muted);font-size:.76rem}.quick-build-ability-controls{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:12px}.quick-build-ability-field{display:grid;gap:6px;min-width:0;color:var(--qb-text-body);font-size:.82rem}.quick-build-ability-field select{width:100%;min-width:0;min-height:44px;margin:0;padding:8px 34px 8px 12px;border:1px solid var(--qb-border);border-radius:8px;background:var(--qb-surface);color:var(--qb-text);font:inherit;font-size:1rem}.quick-build-ability-field select:focus-visible{border-color:var(--qb-accent);outline:2px solid var(--qb-accent);outline-offset:1px}.quick-build-ability-field select:disabled{border-color:var(--qb-border-soft);background:var(--qb-surface-soft, var(--surface-soft));color:var(--qb-border);opacity:1}.quick-build-ability-total{display:grid;gap:2px;justify-items:end}.quick-build-ability-total span{color:var(--qb-text-muted);font-size:.75rem}.quick-build-ability-total strong{color:var(--qb-accent-text);font-size:1.45rem;line-height:1}.quick-build-ability-help{display:flex;flex-wrap:wrap;gap:6px 16px;margin:0 0 18px;color:var(--qb-text-muted);font-size:.88rem}.quick-build-ability-help strong{color:var(--qb-text-body)}.quick-build-complete{padding:18px;border-left:4px solid #22c55e;border-radius:8px;background:#052e24;color:#d1fae5}.quick-build-plan{margin:20px 0 0;padding-left:1.4rem;line-height:1.8;color:var(--qb-text-body)}.quick-build-plan li.current{color:var(--qb-accent-text);font-weight:700}
      .quick-build-class-card{min-height:128px!important}.quick-build-class-card p{margin:0;color:#dbeafe;line-height:1.55}.quick-build-substep-actions{display:flex;justify-content:space-between;gap:12px;margin-top:18px}.quick-build-substep-actions button{min-height:46px;padding:9px 16px;border:1px solid var(--qb-border);border-radius:8px;background:var(--qb-surface-raised);color:#fff;cursor:pointer}.quick-build-substep-actions button.primary{border-color:var(--qb-accent);background:var(--qb-accent-strong, var(--accent-strong))}.quick-build-substep-actions button:disabled{cursor:not-allowed;opacity:.45}.quick-build-proficiency-grid{display:grid;gap:14px}.quick-build-fixed-list{margin:12px 0 0;padding:12px;border-radius:8px;background:var(--qb-surface-inset);color:var(--qb-text-body);line-height:1.6}.quick-build-summary-list{display:grid;grid-template-columns:auto 1fr;gap:8px 14px;margin:0}.quick-build-summary-list dt{color:var(--qb-text-muted)}.quick-build-summary-list dd{margin:0;color:var(--qb-text)}.quick-build-ability-summary{display:grid;gap:6px}.quick-build-ability-summary-row{display:flex;flex-wrap:wrap;gap:6px 10px;align-items:baseline}.quick-build-ability-modifier{font-weight:800;color:#bfdbfe}.quick-build-ability-modifier-sign{color:#fbbf24}.quick-build-ability-modifier-value{color:#67e8f9}.quick-build-complete .quick-build-summary-list dt{color:#a7f3d0}.quick-build-complete .quick-build-summary-list dd{color:#ecfdf5}.quick-build-source-warning{margin-top:10px;color:#fde68a;font-size:.9rem}.quick-build-complete{padding:18px;border-left:4px solid #22c55e;border-radius:8px;background:#052e24;color:#d1fae5}.quick-build-plan{margin:20px 0 0;padding-left:1.4rem;line-height:1.8;color:var(--qb-text-body)}.quick-build-plan li.current{color:var(--qb-accent-text);font-weight:700}
      #quick-build-wizard .quick-build-footer{display:flex;flex:0 0 auto;align-items:center;justify-content:space-between;gap:12px;padding:16px 20px;border-top:1px solid var(--qb-border-soft)}#quick-build-wizard .quick-build-footer[hidden]{display:none}#quick-build-wizard .quick-build-footer-group{display:flex;gap:10px}
      #quick-build-wizard .quick-build-footer button{width:auto;min-width:0;min-height:42px;padding:8px 16px;border:1px solid var(--qb-border);border-radius:8px;background:var(--qb-surface-raised);color:#fff;cursor:pointer}.quick-build-footer button.primary{border-color:var(--qb-accent);background:var(--qb-accent-strong, var(--accent-strong))}.quick-build-footer button:disabled{cursor:not-allowed;opacity:.45}
