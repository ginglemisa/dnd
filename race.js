...
吐息武器─你可用吐息魔法替代一次<strong>攻擊</strong>，範圍二選一： 15 英呎錐形或 5×30 英呎線形（吐息前決定）。區域內生物進行<strong>敏捷豁免</strong>（DC=8+熟練加值+體質調整值）。失敗受 1d10 點傷害，成功減半。使用次數＝熟練加值，長休後恢復。等級５時，吐息傷害改為 2d10。

傷害抗性─“龍族血統”特性對應的屬性傷害減半。
...
石中精妙─使用<strong>附贈動作</strong>獲得持續 10 分鐘的 60 英呎<strong>震顫感知</strong>，需接觸石質表面才能感知。使用次數＝熟練加值，長休後恢復。
`,
  elf: `生物類型： 類人生物
體型：中型（約 5-6 英呎高）
速度：30 英呎
...
你始終準備血統法術，可免費施展一環、二環法術各一次，之後需消耗環位。長休後免費次數恢復。選擇智力、感知、魅力其一為施法屬性（選擇血統時決定）。

精類血統─對<strong>魅惑狀態</strong>的豁免具有優勢。

敏銳感官─洞悉、察覺、求生；三擇一獲得熟練項。

出神─你不需要睡覺，魔法也無法讓你入眠。你的長休是 4 小時的出神冥想，且期間內意識保持清醒。
`,
  gnome: `生物類型：類人生物
體型：小型（約 3-4 英呎高）
速度：30 英呎
...
🧒🏽巖侏儒─你學會<strong>修復術(0)</strong>和<strong>魔法伎倆(0)</strong>。可花10分鐘製造<strong>微型發條裝置</strong>（AC5，HP1），如玩具、打火機或音樂盒。效果選自魔法伎倆；任何生物都可用<strong>附贈動作</strong>觸碰並啟動; 最多３個，８小時後解體，可用動作拆除。
`,
  goliath: `生物類型：類人生物
體型：中型（約 7-8 英呎高）
速度：35 英呎
...
安如磐石（石巨人）─受傷時可用<strong>反應動作</strong>扣除傷害，擲 1d12 + 體質調整值。

驅雷掣電（風暴巨人）─使用<strong>反應動作</strong>對 60 英呎內傷害你的生物造成 1d8 雷鳴傷害。
...
<table border="1" style="border-collapse: collapse; text-align: center;"> <tr> <th>等級</th> <th>深淵血統</th> <th>冥界血統</th> <th>煉獄血統</th> </tr> <tr> <td>1</td> <td>毒素傷害抗性<br><strong>毒氣噴濺(0)</strong></td> <td>黯蝕傷害抗性<br><strong>凍寒之觸(0)</strong></td> <td>火焰傷害抗性<br><strong>火焰箭(0)</strong></td> </tr> <tr> <td>3</td> <td><strong>致病射線(1)</strong></td> <td><strong>虛假生命(1)</strong></td> <td><strong>煉獄叱喝(1)</strong></td> </tr> <tr> <td>5</td> <td><strong>定身術(2)</strong></td> <td><strong>衰弱射線(2)</strong></td> <td><strong>黑暗術(2)</strong></td> </tr> </table>
