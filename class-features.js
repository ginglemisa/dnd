...
</table><strong>探索套組：</strong>背包、床卷、2 瓶油、10 天的口糧、繩索、火絨盒、10 根火把、水袋。
...
`,
  ...
  <tbody>
    ...
    <tr style="border-top: 3px solid #444;">
      <td style="font-weight: bold;">技能熟練項</td>
      <td>從${skillTip("奧秘")}、${skillTip("歷史")}、${skillTip("洞悉")}、${skillTip("調查")}、${skillTip("醫學")}、${skillTip("自然")}或${skillTip("宗教")}中選擇兩項</td>
    </tr>
    <tr style="border-top: 3px solid #444;">
      <td style="font-weight: bold;">武器熟練項</td>
      <td>簡易武器</td>
