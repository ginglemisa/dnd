...
<hr style="border: none; height: 1px; background: linear-gradient(to right, transparent, #dfe5f0, transparent); margin: 10px 0;">
...
可重複：可多次選此祈喚，但每次要選不同戲法。
星移步法（先決條件：術士等級 5+）
你可隨意對自己施展「浮空術」，且不耗法術位。
萬形之主（先決條件：術士等級 5+）
你可隨意施展「變造自身」，且不耗法術位。
融身入影（先決條件：術士等級 5+）
當你在微光或黑暗中時，可隨意對自己施展「隱形術」，且不耗法術位。
深海饋贈（先決條件：術士等級 5+）
