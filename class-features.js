...
吟遊詩人等級達到 9 級時，你再選擇兩項已有熟練的技能，並獲得其專精。
...
當你達到牧師 4 級和 10 級時，你可以從“牧師法術列表”中學習一個新的戲法，正如“牧師特性”表中“戲法”一欄所示。
...
等級提升會增加擲出 d8 骰的數量。當你達到牧師 7 級時 2d8、13 級時 3d8、18級時 4d8。
...
生命領域法術(等級 3)：援助術，祝福術，療傷術，次級覆原術。
(等級 5、7、9 的法術不列出，請查閱 PHB 。)
...
當你達到德魯伊 4 級和 10 級時，你可以從“德魯伊法術列表”中學習一個新的戲法，正如“德魯伊特性”表中“戲法”一欄所示。
...
已知形態。你通過該特性已知四種野獸形態，這些形態將由你從挑戰等級最大為 1/4 且不具有飛行速度的野獸中挑選（數據面板參考附錄 B），推薦選擇 老鼠、馱用馬、蜘蛛 和 狼。當你完成長休時，你可以用另一個符合條件的野獸替換你已知的某個形態。
...
奉獻之誓法術(等級 3)：防護善惡，虔誠護盾
(等級 5、9、13、17 法術不列出，請查閱 PHB )
